...
<head>
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form id="form1" runat="server">
            ...
            <%--<!-- Prompt for Artist ID -->
            <asp:Label ID="lblPrompt" runat="server" Text="Enter Artist ID:" />
            <asp:TextBox ID="txtArtistID" runat="server"></asp:TextBox>
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
            <br /><br /> <!-- Spacing for layout purposes -->
			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image runat="server" ID="heroImage" class="details-banner--hero--img" ImageUrl="./img/31.jpg" Attributes ="srcset'./img/31.jpg, 
						./img/31.jpg 2x'" alt =""/>
                    </div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
							<asp:Image runat="server" ID="bannerImage" ImageUrl="./img/174.jpg" Attributes ="srcset'./img/174-sm.jpg,
								 			./img/174.jpg 2x'" alt="alt"  />
                        </a>
						<h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#">
                            <asp:Literal runat="server" ID="BannerName"></asp:Literal>
                        </a></h1>
					</div>
				</div>
							...
							<main class="discovery--section">
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<asp:Repeater runat="server" ID="Songs">
											...
											<div class="song-list--item--right">
												...
												<a href="#" class="song-list--item--primary"></a>
											<%--	<a class="song-list--item--secondary"><%# Eval("title") %>></a>--%>
												<a class="song-list--item--secondary"><%# Eval("songTitle") %></a>
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p>
											<asp:Literal ID="Biography" runat="server"></asp:Literal>
                                        </p>
                                        <a href="#">Read More...</a>
									</div>
            ...
            <div class="modal" tabindex="-1" role="dialog" id="artistIdModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Enter Artist ID</h5>
                        </div>
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Submit" OnClientClick="closeArtistIdModal();" OnClick="btnSubmit_Click" />
                        </div>
                    </div>
                </div>
            </div>
            <script type="text/javascript">
                $(document).ready(function () {
                    $('#artistIdModal').modal('show');
				});
                function closeArtistIdModal() {
                    document.getElementById('artistIdModal').style.display = 'none';
                    $('body').removeClass('modal-open');
					$('.modal-backdrop').remove();
					$('#artistIdModal').modal('hide');
                }
            </script>
